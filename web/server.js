...
const recruitForm = require("./Model/recruitForm")
...
app.post('/recruitment', (req, res) => {
    ...
    .then(recruit => {
        res.json({
            message: 'Thanks for filling up the form. We will be in touch with you asap!'
        })
    })
    .catch(error => {res.json({
        message: "An error occured! Try again. Student id must be of exactly 10 characters."
